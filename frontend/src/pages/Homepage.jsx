        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-8 h-8  flex items-center justify-center">
                  <img src={bytebattle}  height={30} width={40} alt="bytebattle-logo" />
                </div>
                <span className="text-xl font-bold text-white">ByteBattle</span>
              </div>
          ...
          <div className="pt-8 mt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Anurag Kumar. All rights reserved. Built with ❤️ for developers worldwide.
            </p>
